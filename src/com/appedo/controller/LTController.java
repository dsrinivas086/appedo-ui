...
public class LTController extends HttpServlet {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
		...
		if (strRequestAction.endsWith("/lt/uploadJmeterScript")){
			wsm.addMultipartIntoParameter(request);
		}
		wsm.sendRequest(Constants.APPEDO_UI_LT_SERVICES + strRequestAction, request );
